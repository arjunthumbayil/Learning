...
const reactHeading = /*#__PURE__*/ (0, _reactDefault.default).createElement('h1', {
    id: 'heading'
}, 'Hello From React');
...
const reactRoot = (0, _reactDomDefault.default).createRoot(document.getElementById('root3'));
